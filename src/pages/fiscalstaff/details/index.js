...
class ApproverDetailPage extends Component {
    ...
    getUsedBudget() {
        const { email, ft_selected_formdata } = this.props;
            ...
            budget_cardlist.push(
                <Col span={6}>
                    { 
                        ...
                        approved_budget === 0 ? <Card className='budgetCard' title={`${budgetnumber} $${budgetamount}`} headStyle={{background:'#fcd490'}}>{ approvers_list }</Card> :
